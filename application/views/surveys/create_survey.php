<main class="main">
    ...
    <div class="container-fluid">
        ...
        <div class="card card-accent-primary" id="text-card">
            ...
            <div class="card-body">
                <div class="form-group">
                    <input type="button" class="btn btn-outline-dark" id="switch" value="<?php echo $strings->button_switch ?>">
                </div>
        ...
        <div class="card card-accent-primary" id="skala-card">
            <div class="card-header">
                <?php echo $strings->card_header_create ?>
            </div>
            <?php echo form_open_multipart('surveys/create_survey'); ?>
            <div class="card-body">
                <div class="form-group">
                    <input type="button" class="btn btn-outline-dark" id="switch-back" value="<?php echo $strings->button_switch_back ?>">
                </div>
                <?php echo validation_errors(); ?>
