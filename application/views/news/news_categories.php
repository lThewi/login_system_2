<main class="main">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><?php echo $strings->news_breadcrumb_2 ?></li>
        <li class="breadcrumb-item active"><?php echo $strings->news_breadcrumb_3 ?></li>
    </ol>
    <div class="container-fluid">
        ...
        <div class="card card-accent-primary">
            ...
            <div class="card-body">
                ...
                if($cat) {
                    echo '<table class="table table-responsive-sm table-hover table-outline sorted_table news-cat-table" id="news-cat-table">';
                    ...
                    foreach ($cat as $item) {
                        ...
                        echo '<td>';
                        echo '<a href="' . base_url() . 'news_categories/create_category/' . $item->id . '" class="btn btn-md btn-primary mx-1">'. $strings->button_mod.' </a>';
                        echo '<a href="#" class="btn btn-md btn-danger mx-1 delete-news-category" data-id="' . $item->id . '">'. $strings->button_delete.' </a>';
                        echo '</td>';
                        echo '</tr>';
                    }
                    echo '</tbody>';
